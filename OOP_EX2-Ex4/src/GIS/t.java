...
/**
 * This class represents an implementation of the GIS_element interface, in this class we create a toGIS_element
 * holding an Array of Strings for the data and an Array of Strings for the name of the data -> Elements
 * This class has a few simple functions like: get_Meta_Data, getGeom, getName, getTimeStamp, translate etc.
 *
...
public class toGIS_element implements GIS_element{
	...
	/**
	 * This function returns the Meta_data associated with the element.
	 * TimeStamp, Data, UTC, Orientation, toString
	 * 
	 * @return Meta_data
	 */
	@Override
	...
	/**
	 * This function returns the name of the Object element by searching for the category of
	 ...
	 * 
	 * For example -> search for category: "LastSeen" -> return the index of the category searched column.
	 * 
